...
def index():
    if 'username' in session:
        ...
        if contains_xss(username):
            ret += "<script>alert('flag{人類有三大慾望：食慾、性慾、睡眠欲，而在這三大慾望之中，因為食慾是滿足人類生存需求的慾望，所以，滿足食慾的行為，在這三者之中，優先是第一位的，如果能在進食的過程中，吃下了美味的食物，也能使人類無比愉快，而在現實生活中，存在著這種對快感執著追求的人，我們通常把這種人稱之為美食家，而本餐廳則專門為那些厭倦世間常見美食的人，量體裁衣，提供符合他們身份的美食。}')</script>"
        if username=="𰻞𰻞龘齉𱁬𪚥𠔻䨻䲜朤":
            ret+="<script>alert('flag{嚴厲斥責你發瘋啦這什麼東西啦不可以啊不要再亂搞了啦不要再蝦幾把搞了啦你幹嘛這樣啊怎麼這麼激烈啊不可以這樣子啊發瘋了是不是啊啥小啦不要不可以不可以講什麼話啊操擊敗勒啦冷靜一點啦幹這到底又是什麼東西不可以啦這是能講的話嗎絕對不可以的啊}')</script>"
        return ret
...
def login():
    if request.method == 'POST':
        ...
        if user:
            ...
            session['flag'] = "flag{太大聲太小聲去跟舍監反應🗣️🗣️會改進 不想聽可以包一包滾回🫦…滾出宿舍🔥🔥🔥👺👺👺 不是像沒爸沒媽🤏🤏🤏對老子的歌指指點點🖕🖕 老子播什麼你聽什麼🗣️🗣️🤡🤡👊👊👊👊 另外！靠杯一中版的 🗣️🗣️🗣️（哦哦哦哦哦哦哦） 🗣️🗣️🗣️🗣️🗣️靠杯一中版🗣️🗣️🗣️ （哦哦哦哦哦） 🗣️🗣️🗣️🗣️🗣️的🗣️🗣️🗣️（哦哦哦哦哦哦） 🗣️🗣️🗣️🗣️🗣️近期對於公開平台🗣️🗣️🗣️（哦哦哦哦哦哦）🗣️🗣️🗣️🗣️🗣️（沃草）🗣️🗣️🗣️🗣️🗣️（哦哦哦哦哦哦）（119）🗣️🗣️🗣️🗣️🗣️🗣️🗣️🗣️🗣️🗣️🗣️🗣️}"  # 這裡放置flag
